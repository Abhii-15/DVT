...
class ChannelsConfigView(QWidget):
    ...
    def _init_ui(self) -> None:
        ...
        title.setStyleSheet("font-weight: bold; font-size: 14px; color: #7ab8f5;")
        ...
        # Make the table expand to use available space
        self._table.setSizeAdjustPolicy(self._table.AdjustToContents)
        ...
        # Let the whole panel expand vertically to avoid unused gaps
